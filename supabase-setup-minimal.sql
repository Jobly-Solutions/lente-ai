-- Lente AI Database Setup - Minimal Version
-- Ejecutar este script en el SQL Editor de Supabase
-- Versión mínima que evita problemas de tipos de datos
...
-- ========================================
-- 5. ROW LEVEL SECURITY (SIMPLIFICADO)
-- ========================================
...
-- Políticas básicas para agents (solo admin)
...
-- Políticas básicas para assignments (solo admin)
...
-- Políticas básicas para conversations
...
-- Políticas básicas para scout_config (solo admin)
