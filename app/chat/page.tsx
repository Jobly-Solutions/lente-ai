...
function ChatContent() {
  ...
  async function sendMessage() {
    ...
    const saveUserId = userId || uuidv4()
    try {
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <Card className="h-[75vh] flex flex-col">
            ...
            <CardContent className="flex-1 flex flex-col p-0">
                {/* Messages Area */}
                <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 space-y-4 chat-message-container">
                  {messages.length === 0 && selectedAgent ? (
                    ...
                    messages.map((message) => (
                      ...
                      >
                        <div
                          className={`px-4 py-2 rounded-lg chat-message-bubble ${
                            message.role === 'user'
                          ...
                          <div className="text-sm prose prose-sm max-w-none">
                            <ReactMarkdown 
                              ...
                              components={{
                                ...
                                pre: ({ children }) => <pre className="bg-gray-100 p-2 rounded text-xs font-mono overflow-x-auto mb-2 whitespace-pre-wrap">{children}</pre>,
