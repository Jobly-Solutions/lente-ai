-- Lente AI Database Setup - Working Version
-- Ejecutar este script en el SQL Editor de Supabase
-- Versión que funciona sin errores de restricciones
...
-- Tabla de configuración global (sin restricciones problemáticas)
CREATE TABLE IF NOT EXISTS public.scout_config (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    api_key TEXT NOT NULL,
    default_agent_id TEXT DEFAULT 'default',
    welcome_message TEXT DEFAULT '¡Hola! Soy tu asistente de IA.',
    context TEXT DEFAULT 'Eres un asistente de IA útil y amigable.',
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW()
);
...
BEGIN
    ...
    RAISE NOTICE '⚠️  Políticas RLS básicas configuradas';
END $$;
